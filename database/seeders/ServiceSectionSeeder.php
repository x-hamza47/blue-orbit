                ...
                switch ($type) {
                    ...
                    case 'hero':
                        $data = [
                            ...
                            'review' => "Trusted by global clients for reliable performance.",
                        ...
                        $data = [
                            'items' => $related->map(function ($r) {
                                return [
                                    'slug' => $r->slug,
                                    'title' => $r->title,
                                    'desc' => $r->description ?? "Professional service solution."
                                ];
                            })->toArray()
                        ];
                        break;
                    ...
                    case 'tech':
                        $data = [
                            ...
                            'subheading' => "Modern tools and frameworks",
                            'items' => []
                        ];
                    ...
                    case 'casestudy':
                        ...
                        for ($i = 0; $i < 3; $i++) {
                            $data['items'][] = [
                                ...
                                'service' => Service::inRandomOrder()->value('title')
                            ];
                        }
                        break;
