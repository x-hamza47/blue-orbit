    ...
    <div class="mx-auto max-w-480 px-[clamp(1.5rem,5vw,5rem)]">
        ...
        <div class="mb-8 max-w-4xl">
            <h2 class="font-black text-[#010521] leading-tight mb-6" style="font-size: clamp(2.5rem, 6vw, 3.5rem);">
                How BlueOrbit’s Marketing <br><span class="text-[#4373F6]">Consulting Helps</span>
            </h2>
            <p class="text-gray-500 text-lg font-medium">
                We bridge the gap between disjointed tactics and high-performance growth engines.
            </p>
        </div>
