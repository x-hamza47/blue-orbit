            ...
            <div class="divide-y sm:divide-gray-50 divide-gray-400">
                ...
                {{-- <div class="grid grid-cols-1 md:grid-cols-4 items-stretch divide-x divide-gray-50 md:divide-x-0 group">
                    ...
                    <div
                        ...
                        <p class="text-sm leading-relaxed font-semibold">Personal account manager who understands your
                            business</p>
                    </div>
                    <div class="p-6 sm:p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Rotation of key account managers
                        </p>
                    </div>
                    <div class="p-6 sm:p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">No expert support</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-4 items-stretch divide-x divide-gray-50 md:divide-x-0 group">
                    <div class="p-6 sm:p-8 flex items-center md:bg-gray-50/20">
                        <span class="text-(--color-secondary) font-bold text-base sm:text-lg">Strategy Approach</span>
                    </div>
                    <div
                        class="p-6 sm:p-8 lg:p-10  bg-(--color-secondary)/5 text-(--color-secondary) border-l-4 border-l-(--color-primary) relative group-hover:bg-(--color-secondary)/10 transition-colors">
                        <span class="absolute top-4 right-4 text-(--color-primary) text-xl font-bold">✓</span>
                        <p class="text-sm leading-relaxed font-semibold">Fully customized strategy aligned to your goals
                        </p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Generic, template based strategies
                        </p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Trial & error approach</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 items-stretch divide-x divide-gray-50 md:divide-x-0 group">
                    ...
                    <div
                        ...
                        <span class="absolute top-4 right-4 text-(--color-primary) text-xl font-bold">✓</span>
                        <p class="text-sm leading-relaxed font-semibold">Detailed monthly reports with actionable
                            insights</p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Basic reports, often delayed</p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Manual tracking</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 items-stretch divide-x divide-gray-50 md:divide-x-0 group">
                    ...
                    <div
                        class="p-8 md:p-10 bg-(--color-secondary)/5 text-(--color-secondary) border-l-4 border-l-(--color-primary) relative group-hover:bg-(--color-secondary)/10 transition-colors">
                        <span class="absolute top-4 right-4 text-(--color-primary) text-xl font-bold">✓</span>
                        <p class="text-sm leading-relaxed font-semibold">No long-term contracts, stick because it works
                        </p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">6–12 month contracts</p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">No commitment</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-4 items-stretch divide-x divide-gray-50 md:divide-x-0 group">
                    <div class="p-6 sm:p-8  flex items-center md:bg-gray-50/20">
                        <span class="text-(--color-secondary) font-bold text-base sm:text-lg">ROI Tracking</span>
                    </div>
                    <div
                        class="p-8 md:p-10 bg-(--color-secondary)/5 text-(--color-secondary) border-l-4 border-l-(--color-primary) relative group-hover:bg-(--color-secondary)/10 transition-colors">
                        <span class="absolute top-4 right-4 text-(--color-primary) text-xl font-bold">✓</span>
                        <p class="text-sm leading-relaxed font-semibold">Advanced tracking with transparent ROI
                            visibility</p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
                        <p class="text-gray-500 text-sm leading-relaxed font-medium">Limited tracking, unclear ROI</p>
                    </div>
                    <div class="p-8 flex items-start group-hover:bg-gray-50/20 transition-colors">
                        <span class="text-gray-400 text-xl font-bold mr-3 mt-0.5">X</span>
