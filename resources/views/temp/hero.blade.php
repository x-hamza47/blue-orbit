            ...
            <div class="flex flex-col space-y-8">
                <div>
                    <h1
                        ...
                        Digital Marketing services built to drive
                        <span class="text-(--color-primary)">Growth </span>
                        <br />
            ...
            <div class="relative flex justify-center lg:justify-end">
                ...
                <div
                    ...
                    <p class="text-(--color-secondary) text-sm leading-relaxed font-medium">
                        "Business trust our digital marketing services for clear guidance, strategy consultancy,
                        measurable results & persistent growth."
                    </p>
                    <p class="sm:mt-4 mt-3 text-(--color-primary) font-bold text-sm">— Olivia</p>
                </div>
            </div>
