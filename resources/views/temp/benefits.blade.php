    ...
    <div class="mx-auto max-w-480 px-[clamp(1.5rem,5vw,5rem)]">
        ...
        <div class="mb-8">
            <h2 class="font-black text-[#010521] leading-tight mb-6" style="font-size: clamp(2.5rem, 6vw, 3.5rem);">
                Major Benefits of <span class="text-[#4373F6]">Digital Marketing</span>
            </h2>
            <p class="text-gray-500 max-w-4xl text-lg leading-relaxed font-medium">
                Digital marketing is the most effective way to scale your brand authority and drive measurable ROI. With
                data-driven strategies across 30+ industries, we deliver precision-targeted campaigns that convert
