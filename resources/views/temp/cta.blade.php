<section class="w-full py-10 bg-white">
    <div class="mx-auto max-w-480 px-[clamp(1.5rem,5vw,5rem)]">
        ...
        <div class="relative bg-(--color-secondary) rounded-3xl sm:rounded-4xl md:rounded-[3.5rem] p-6 sm:p-8 md:p-10 overflow-hidden shadow-xl md:shadow-2xl shadow-(--color-secondary)/30">

            <div class="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-(--color-primary)/20 to-transparent"></div>
            <div class="absolute -bottom-24 -left-24 md:w-96 md:h-96 sm:w-80 sm:h-80 w-72 h-72 bg-(--color-primary) rounded-full blur-[80px] opacity-20"></div>
            ...
            <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-8">
                    ...
                    <p class="text-gray-400 text-lg lg:text-xl font-medium max-w-2xl leading-relaxed">
                        Build around your goals, backed by data, designed for growth.
                    </p>
                </div>
