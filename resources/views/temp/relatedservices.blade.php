    ...
    <div class="mx-auto max-w-480 px-[clamp(1.5rem,5vw,5rem)]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
                ...
                <h3 class="text-[#010521] font-black text-2xl mb-4">Content Marketing</h3>
                <p class="text-gray-500 font-medium leading-relaxed mb-8">
                    Fuel your organic growth with high-authority blog posts, whitepapers, and case studies designed to
