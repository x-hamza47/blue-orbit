@php
    $services = [
        [
            ...
            'desc'   => 'Rank higher on Google for high-intent UAE searches. We\'ve placed 500+ keywords on Page 1 for clients across Dubai, Sharjah, and Abu Dhabi.',
            'slug'   => 'seo',
        ],
        [
            'icon'   => 'target',
            ...
            'desc'   => 'Results-driven ad campaigns with laser-targeted audiences. Every dirham tracked and optimised for maximum return.',
            'slug'   => 'ppc-google-ads',
        ],
        [
            'icon'   => 'smartphone',
            ...
            'desc'   => 'Platform-native strategies that build UAE audiences, drive engagement, and convert followers into paying customers.',
        ...
        [
            ...
            'desc'   => 'SEO-rich Arabic & English content that ranks, educates, and converts. Blog posts, landing pages, whitepapers, and video scripts.',
        ...
        [
            ...
            'desc'   => 'Lightning-fast, mobile-first websites optimised for UAE buyers. Built on WordPress or custom — designed to rank and convert.',
        ...
        [
            ...
            'desc'   => 'AI-powered campaigns with automated targeting, content creation, and GEO optimisation for ChatGPT & Perplexity visibility.',
        ...
        [
            ...
            'desc'   => 'Broadcast promotions, automate responses, and nurture leads through WhatsApp Business — the #1 UAE engagement channel.',
            ...
            <div class="relative flex flex-col justify-between rounded-[28px] px-7 py-8 overflow-hidden sm:col-span-2 lg:col-span-1"
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-white/70 text-sm leading-relaxed mb-8">
                        We'll analyse your digital presence and recommend the exact mix of services for the best ROI in the UAE market. No jargon. No pushy sales.
                    </p>
                </div>
