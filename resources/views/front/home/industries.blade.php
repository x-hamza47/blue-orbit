@php
    $industries = [
        [
            ...
            'label' => 'Real Estate',
            'color' => '#4373f6',
            'slug' => 'digital-marketing-real-estate-dubai',
        ],
        [
            'icon' => 'hotel',
            'label' => 'Hospitality & Hotels',
            'color' => '#e84545',
            'slug' => 'digital-marketing-hospitality-uae',
        ],
        [
            'icon' => 'heart-pulse',
            'label' => 'Healthcare & Clinics',
            'color' => '#e040fb',
            'slug' => 'digital-marketing-healthcare-uae',
        ],
        [
            'icon' => 'shopping-cart',
            'label' => 'E-Commerce',
            'color' => '#f5a623',
            'slug' => 'digital-marketing-ecommerce-uae',
        ],
        [
            'icon' => 'utensils',
            'label' => 'F&B & Restaurants',
            'color' => '#ff7043',
            'slug' => 'digital-marketing-restaurants-dubai',
        ],
        [
            'icon' => 'scale',
            'label' => 'Legal & Finance',
            'color' => '#00bcd4',
            'slug' => 'digital-marketing-legal-finance-uae',
        ],
        [
            'icon' => 'rocket',
            'label' => 'Free Zone Startups',
            'color' => '#43a047',
            'slug' => 'digital-marketing-freezone-startups-uae',
        ],
        [
            'icon' => 'shirt',
            'label' => 'Retail & Fashion',
            'color' => '#ec4899',
            'slug' => 'digital-marketing-retail-fashion-uae',
        ],
    ];
@endphp
    ...
    <div class="mx-auto w-full max-w-7xl">
        ...
        <div class="flex flex-col md:flex-row justify-between sm:mb-16 mb-10 gap-8">
            ...
            <p class="text-gray-500 max-w-xs text-sm md:text-base leading-relaxed self-end">
                We don't do generic. Every campaign is built around your industry's buyers, seasonality, and competitive
                landscape.
            </p>
        </div>
            ...
            @foreach ($industries as $industry)
                <a href="{{ url('/' . $industry['slug']) }}"
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <span
                            class="text-xs font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center gap-1 mt-0.5"
