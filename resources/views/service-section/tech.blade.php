            ...
            @foreach ($data['items'] as $item)
                <div
                    ...
                    <i data-lucide="{{ $item['icon'] }}"
                        class="text-2xl text-gray-400 group-hover:text-[#4373F6] transition-colors"></i>
                    <span
                        class="font-bold text-[#010521] group-hover:text-[#4373F6] transition-colors text-sm">{{ $item['title'] }}</span>
                </div>
            @endforeach
